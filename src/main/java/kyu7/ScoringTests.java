...
public class ScoringTests {
     ...
     * A certain number of points will be given for each correct answer and a certain number
     * of points will be deducted for each incorrect answer. For ommitted answers, points will
    ...
    public static int getScore(int[] arr, int r, int o, int w) {
        int rightCounter = 0;
        ...
        return rightCounter*r + omittedCounter*o - wrongCounter*w;
    }
}
